...
namespace BankLibrary.Models
{
	...
	{
		public DepositAccount(decimal sum, int percentage, IEventNotifier notifier) : base(sum, percentage, notifier)
		{
		}
		protected internal override void Open()
		{
			Notifier.NotifyAboutEventByType(EventType.AccountOpen,$"Opened new deposite account! Id: {this.id}");
        }
